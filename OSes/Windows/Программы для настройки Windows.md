## Программы для настройки Windows

- [Программы для настройки Windows](#программы-для-настройки-windows)
  - [Бесплатные:](#бесплатные)
  - [Платные:](#платные)
  - [С возможностью экспорта и импорта настроек:](#с-возможностью-экспорта-и-импорта-настроек)
